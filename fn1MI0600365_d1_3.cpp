...
const int SHIP_TYPES = 4;  // Updated to 4

const char isWATER = 'W';  // ASCII Character Code
const char isHIT = 'X';
const char isSHIP = 'S';
const char isMISS = '0';
...
void LoadShips()
{
    ship[0].name = "Boat"; ship[0].length = 2;
    ship[1].name = "Submarine"; ship[1].length = 3;
    ship[2].name = "Destroyer"; ship[2].length = 4;
    ship[3].name = "Aircraft"; ship[3].length = 5;
}
